...
set CLASSPATH="%BASEDIR%"\etc;"%REPO%"\tupleflow-3.8-SNAPSHOT.jar;"%REPO%"\trove4j-3.0.3.jar;"%REPO%"\utility-3.8-SNAPSHOT.jar;"%REPO%"\jetty-server-7.6.8.v20121106.jar;"%REPO%"\javax.servlet-2.5.0.v201103041518.jar;"%REPO%"\jetty-continuation-7.6.8.v20121106.jar;"%REPO%"\jetty-http-7.6.8.v20121106.jar;"%REPO%"\jetty-io-7.6.8.v20121106.jar;"%REPO%"\jetty-util-7.6.8.v20121106.jar;"%REPO%"\commons-compress-1.8.jar;"%REPO%"\xz-1.5.jar;"%REPO%"\core-3.8-SNAPSHOT.jar;"%REPO%"\tupleflow-gridengine-3.8-SNAPSHOT.jar;"%REPO%"\drmaa-1.0.jar;"%REPO%"\eval-3.8-SNAPSHOT.jar;"%REPO%"\snowball-stemmers-3.8-SNAPSHOT.jar;"%REPO%"\krovetz-stemmer-3.8-SNAPSHOT.jar;"%REPO%"\bliki-core-3.0.19.jar;"%REPO%"\commons-httpclient-3.1.jar;"%REPO%"\xmlenc-0.52.jar;"%REPO%"\snappy-java-1.0.5-M4.jar;"%REPO%"\reflections-0.9.8.jar;"%REPO%"\guava-11.0.2.jar;"%REPO%"\jsr305-1.3.9.jar;"%REPO%"\javassist-3.12.1.GA.jar;"%REPO%"\dom4j-1.6.1.jar;"%REPO%"\xml-apis-1.0.b2.jar;"%REPO%"\libthrift-0.8.0.jar;"%REPO%"\slf4j-api-1.5.8.jar;"%REPO%"\commons-lang-2.5.jar;"%REPO%"\httpclient-4.1.2.jar;"%REPO%"\commons-logging-1.1.1.jar;"%REPO%"\commons-codec-1.4.jar;"%REPO%"\httpcore-4.1.3.jar;"%REPO%"\contrib-3.8-SNAPSHOT.jar
